...
if __name__=="__main__":
	...
	while dataset_next:
		print(dataset_next)
		try:
			datasets_body=GetJSONResponse(f"{HOST}{dataset_next}",headers={"accept": "application/json"})
	...
	with open("dryad.csv", 'w') as fout:
		...
		for D,dataset in enumerate(DATASETS):
			...
			while file_next:
				try:
					files_body=GetJSONResponse(f"{HOST}{file_next}",headers={"accept": "application/json"})
